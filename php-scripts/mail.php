...
if (isset($_POST["pay_mail"])) {
    $arr = $_POST["pay_mail"] ;
    $text = isset($_POST["message"])&&trim($_POST["message"])!=""?$_POST["message"]:"NHL VIRTUAL COINS";
    $subj = isset($_POST["subject"])&&trim($_POST["subject"])!=""?$_POST["subject"]:"NHL VIRTUAL COINS";
